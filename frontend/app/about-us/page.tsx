          ...
          <div className="col-span-12 lg:col-span-8 space-y-16">
            ...
            <section>
              ...
              <div className="space-y-5 text-gray-600 leading-relaxed">
                ...
                <p>
                  Така се роди Социолог.bg. Не от голяма корпорация, не от политическа организация —
            ...
            <section>
              ...
              <div className="space-y-5 text-gray-600 leading-relaxed">
                ...
                <p>
                  Всеки глас на платформата е криптографски защитен — технически невъзможно е
                  да се установи кой е гласувал как. Не защото разчитаме на добросъвестност,
