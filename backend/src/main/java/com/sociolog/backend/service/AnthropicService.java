...
public class AnthropicService {
    ...
    public String generateArticle(String topic) {
        ...
        JSON СТРУКТУРА:
        {
          "title": "Интригуващо, но точно заглавие на статията",
          "content": "Пълният текст на статията тук, като използваш \\n\\n за разделяне на параграфите",
          "summary": "Кратко резюме (1-2 изречения), подходящо за водеща новина",
          "surveyQuestion": "Един провокиращ размисъл въпрос за анкета, пряко свързан с темата"
        }
        """,
                "messages", List.of(
